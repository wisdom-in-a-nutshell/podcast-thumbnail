...
DEFAULT_PROMPT = (
    ...
    " Use a clean background appropriate to the chosen template. Render the title text exactly as provided."
    " Words wrapped in *asterisks* should be highlighted with a red box and white text (remove the asterisks in the final render)."
    " Ensure legibility on mobile. No extra stickers, no watermarks, no logos. 16:9 composition, polished and professional."
)
...
def _cache_key(
    *,
    ...
    for part in (model, title_text, aspect_ratio, template, prompt_signature):
...
def compose_thumbnail(
    ...
    *,
    ...
    prompt_signature = f"{DEFAULT_PROMPT}|{style_prompt}"
    ...
    prompt = (
        ...
        " Place the title at the top, compact, filling the upper third; keep tight line spacing and avoid excessive empty space."
